...
async function handleMapClick(event, map) {
    ...
    // send the closest field home plate coordinates to the function that calculates the distance from the click to the home plate
    // const distance = drawLine(event.latLng, closestField.home_plate);
